              ...
              >
                <div className="relative">
                  <input
                    ...
                    name="email"
                    type="text"
                    className="peer  h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600 rounded"
                ...
                <div className="relative">
                  <button
                    className="bg-green-500 
                                mt-5 text-white rounded-md px-2 py-1 hover:bg-black"
                  >
                    Log In
                  </button>
                </div>
